...
const Rules = () => {
    ...
    return (
        ...
        <div className='body-app '>
            ...
            <p className="rulesContainer text-left back-text container rounded">Dispondremos de
                <strong>6 casillas</strong> que representan un camino en la zona de carga que lleva hasta el armario donde se encuentra segura
                la mercancía.</p>
            <p className="container-fluid text-center">🔲🔲🔲🔲🔲🔲❎</p>
            <p className="rulesContainer text-left back-text container rounded">De este modo tendremos <strong>7 casillas</strong>,
                6 del camino y una que representa al armario. Durante el viaje has hecho muy bien tu trabajo pero ahora debes vaciar el armario.
                Para ello deberás descargar la mercancía poco a poco. <br />
                <br />Este es el momento más delicado ya que <strong>Grogu</strong> puede aprovechar y llegar hasta el armario.
                Si eso ocurre se comerá lo que encuentre y <strong>Mando</strong> perderá la oportunidad de saber dónde esta
                <strong>Ahsoka</strong>. <strong>Ergo</strong>, te has quedado sin recompensa.<br /><br /> Además de esas
                <strong>7 piezas</strong> tendrás <strong>tres recipientes</strong> donde se guarda cada tipo de mercancía.</p>
            <br /><br />
       

            <p className="rulesContainer text-center back-text container rounded ">
                * Descargas una caja de galletas azules 🍪<br />* Descargas un huevo de rana (con mucho cuidado)🥚<br />
                * Descargas una rana 🐸<br />* Grogu se mueve una casilla 👣
            </p>
            <br /><br />
            <p className="rulesContainer text-left back-text container rounded ">Además habrá una ficha que represente dónde está <strong>
                Grogu. <br /><br />Ganarás el juego si consigues descargar toda la mercancía. Perderás si <strong>Grogu.</strong>
                llega a la última casilla (el armario)</strong></p>
            <Footer />
        </div>
    )
